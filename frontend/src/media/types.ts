...
/** 视频视角标识: front=正面主视角, pop=从动视角 */
export type ViewId = 'front' | 'pop'

/** 管线状态机状态: idle 空闲 / starting 启动中 / running 推理中 / done 完成 / stopped 已停止 */
